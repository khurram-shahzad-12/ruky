...
const page = () => {
  return (
    <Fragment>
      <form className='p-20 border shadow-lg rounded-md container m-auto max-w-screen-md'>
        <div className="space-y-12  ">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900 text-center md:text-4xl">Sign Up Form</h2>
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6 container max-w-screen-md">
